...
class PaymentMessages {
  ...
  static paymentProofRejected(orderId, reason) {
    let message = "❌ *Pembayaran Ditolak*\n\n";
    message += `📋 Order ID: ${orderId}\n`;
    message += `📝 Alasan: ${reason}\n\n`;
    message += "━━━━━━━━━━━━━━━━━━\n\n";
    message += "🔄 *Silakan Upload Ulang Bukti Transfer*\n\n";
    message += "Pastikan:\n";
    message += "✅ Nominal sesuai persis\n";
    message += "✅ Screenshot jelas & lengkap\n";
    message += "✅ Tanggal & waktu terlihat\n\n";
    message += "━━━━━━━━━━━━━━━━━━\n\n";
    message += "📸 Upload bukti transfer baru sekarang,\n";
    message += "atau ketik *menu* untuk kembali ke menu utama.";
    return message;
  }
