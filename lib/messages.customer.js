/**
 * 🛍️ CUSTOMER & PAYMENT MESSAGES
 * 
 * File ini berisi SEMUA pesan untuk customer:
 * - Payment messages (QRIS, E-wallet, Bank, VA)
 * - Customer UI messages (menu, cart, wishlist, order)
 * - Format helpers
 * 
 * 📖 CARA EDIT:
 * 1. Cari section yang mau diubah (Ctrl+F)
 * 2. Edit pesannya
 * 3. Save (Ctrl+S)
